...
def ping(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text(f"💡ᎮᎧᏁᎶ!\n⏱️<b>ᏒᏋᎮᏝᎩ ᏖᎧᎧᏦ:</b> {ping_time}s\n🔮<b>ᏕᏋᏒᏉᎥፈᏋ ᏬᎮᏖᎥᎷᏋ:</b> {uptime}", parse_mode=ParseMode.HTML)

@run_async
def uptime(bot: Bot, update: Update):
	uptime = get_readable_time((time.time() - StartTime))
	update.effective_message.reply_text(f"🔮ᏕᏋᏒᏉᎥፈᏋ ᏬᎮᏖᎥᎷᏋ: {uptime}")    
