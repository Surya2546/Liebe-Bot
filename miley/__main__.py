...
SOURCE_STRING = """
🎓 I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/Shinchan1211/Liebe-bot)
...
if START_IMG is None:
    img = "https://telegra.ph/file/1570bb31730660d7a65d5.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="Liebe News 📰",url="https://t.me/Liebe_News"),InlineKeyboardButton(text="Liebe Support ⚒️",url="https://t.me/Liebe_Support")]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="🔥Contact Creator🔥",url="https://t.me/Mafia_Shinchan_Op")]]))
        return
