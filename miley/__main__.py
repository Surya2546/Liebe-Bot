...
if START_IMG is None:
    img = "https://telegra.ph/file/ce5762b61c28dff2000d3.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🔱Help🔱",callback_data="help_back"),InlineKeyboardButton(text="🔥Creator🔥",url="https://t.me/Shinchu_xD")]]
