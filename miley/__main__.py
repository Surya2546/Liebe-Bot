...
if START_IMG is None:
    img = "https://telegra.ph/file/2728656adea510e231369.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help❓",callback_data="help_back"),InlineKeyboardButton(text="Moi Master 😌",url="https://t.me/Shinchu_xD"),InlineKeyboardButton(text="Liebe News",url="https://t.me/Liebe_News"),InlineKeyboardButton(text="Liebe News",url="https://t.me/Liebe_News"]]
